...
class Config(object):
    ...
    # Get this value by running python3 stringsetup.py or https://replit.com/@tahrkazm/code-termux
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/Source-Demon/Demon2"
    )
    ...
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/4503bd6e774395efb4a42.png"
    )
